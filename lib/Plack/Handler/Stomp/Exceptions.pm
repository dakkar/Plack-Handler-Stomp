...
{
  $Plack::Handler::Stomp::Exceptions::VERSION = '0.1_01';
}
{
...
{
  $Plack::Handler::Stomp::Exceptions::UnknownFrame::VERSION = '0.1_01';
}
{
...
{
  $Plack::Handler::Stomp::Exceptions::AppError::VERSION = '0.1_01';
}
{
...
{
  $Plack::Handler::Stomp::Exceptions::OneShot::VERSION = '0.1_01';
}
{
